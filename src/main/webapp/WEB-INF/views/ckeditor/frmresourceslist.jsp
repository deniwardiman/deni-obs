...
oListManager.GetFolderRowHtml = function( folderName, folderPath )
{
	...
	return '<tr>' +
			'<td width="16">' +
				sLink +
				'<img alt="" src="/resources/plugins/ckeditor/filemanager/browser/default/images/Folder.gif" width="16" height="16" border="0"><\/a>' +
...
oListManager.GetFileRowHtml = function( fileName, fileUrl, fileSize )
{
	...
	return '<tr>' +
			'<td width="16">' +
				sLink +
				'<img alt="" src="/resources/plugins/ckeditor/filemanager/browser/default/images/icons/' + sIcon + '.gif" width="16" height="16" border="0"><\/a>' +
			'<\/td><td>&nbsp;' +
				sLink +
				fileName +
				'<\/a>' +
